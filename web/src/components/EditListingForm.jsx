...
export default function EditListingForm({ listing, onSaved, onCancel }) {
  ...
  return (
    <div className="form-container">
      <button className="btn btn-ghost" onClick={onCancel} style={{ marginBottom: '16px' }}>← Back</button>
      <h2>Edit Listing</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label>Location — click the map to update pickup point</label>
        ...
        <button type="submit" className="btn btn-primary" style={{ width: '100%', marginTop: '8px' }}>Save Changes</button>
      </form>
    </div>
  )
}
